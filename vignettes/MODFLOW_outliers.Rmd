...
MOD2    <- MODFLOW %>% filter(.data$scenario == "irr")
...
ggplot() +
  geom_line(data = MOD1,
            ...
            color = "black",
            alpha = 0.05) +
  geom_line(data = filter(MOD1, .data$sim %in% c(304)),
            aes(x = .data$date,
                y = .data$level_m),
            color = "red") +
  labs(x = "", y = "Lake Elevation (m)", linetype = "") +
...
scenarios ("irr" and "no irr"). Total metrics evaluated:
...
kable(head(outliers_all, 10), caption = "Top 10 outlier simulations")
...
outliers_sub <- outliers %>%
                ...
                dcast(sim~hydrology, value.var = "count",
                      fill = 0) 
kable(head(outliers_sub %>% arrange(desc(.data$duration)), 10), 
           caption = "Top 10, arranged by duration")
kable(head(outliers_sub %>% arrange(desc(.data$frequency)), 10), 
           caption = "Top 10, arranged by frequency")
kable(head(outliers_sub %>% arrange(desc(.data$magnitude)), 10), 
      caption = "Top 10, arranged by magnitude")
kable(head(outliers_sub %>% arrange(desc(.data$rate_of_change)), 10), 
           caption = "Top 10, arranged by rate_of_change")
kable(head(outliers_sub %>% arrange(desc(.data$timing)), 10), 
           caption = "Top 10, arranged by timing")
...
outliers_sub <- outliers %>%
                ...
                dcast(sim+scenario~hydrology, value.var = "count",
                      fill = 0) 
kable(head(outliers_sub %>% arrange(desc(.data$duration)), 20), 
           caption = "Top 20, arranged by duration")
kable(head(outliers_sub %>% arrange(desc(.data$frequency)), 20), 
           caption = "Top 20, arranged by frequency")
kable(head(outliers_sub %>% arrange(desc(.data$magnitude)), 20), 
      caption = "Top 20, arranged by magnitude")
kable(head(outliers_sub %>% arrange(desc(.data$rate_of_change)), 20), 
           caption = "Top 20, arranged by rate_of_change")
kable(head(outliers_sub %>% arrange(desc(.data$timing)), 20), 
           caption = "Top 20, arranged by timing")
...
Evaluate outliers in metric differences (no_irr - irr). Total metrics evaluated:
...
outliers_all <- outliers %>%
                ...
                select(.data$sim, .data$count) %>%
                arrange(desc(.data$count))
kable(head(outliers_all, 10), caption = "Top 10 outliers - all differences")
