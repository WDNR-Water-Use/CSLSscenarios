...
lake <- "Pleasant"
no_irr_shapes  <- draw_rect_lines(bathymetry, exceeds, median, lake, "value1")
threshold_shapes <- draw_rect_lines(bathymetry, exceeds, median, lake, "threshold")
cur_irr_shapes <- draw_rect_lines(bathymetry, exceeds, median, lake, "value2")
